...
class Ui_AdminGameWindow(object):
    def setupUi(self, AdminGameWindow):
        ...
        AdminGameWindow.resize(1200, 900)
        ...
        self.gridLayout.addWidget(self.all_table, 1, 0, 1, 2)
        ...
        self.review_table.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.review_table.setDragDropMode(QtWidgets.QAbstractItemView.NoDragDrop)
        self.review_table.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.review_table.setTextElideMode(QtCore.Qt.ElideMiddle)
        ...
        self.gridLayout.addWidget(self.review_table, 2, 0, 1, 2)
